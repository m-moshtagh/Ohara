...
public class MoshWeightedGraph {
    private class Node {
    ...
    public MoshPath getShortestPath(String from, String to) {
        var fromNode = nodes.get(from);
        if (fromNode == null)
            throw new IllegalArgumentException();
    ...
    public MoshWeightedGraph getMinimumSpanningTree() {
        var tree = new MoshWeightedGraph();
